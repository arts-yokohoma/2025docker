...
<body>
    <div class="container">
        ...
        <div id="shifts-tab" class="tab-content">
            ...
            <!-- Add this after the Capacity Rules section -->
<div class="capacity-status">
    <h3>Real-time Order Capacity</h3>
    <p>Current shift status based on 1 staff = 1 order (30 minutes)</p>
    
    <div class="status-grid">
        <div class="status-card">
            <div class="status-label">Current Shift</div>
            <div class="status-value" id="currentShift">Morning</div>
        </div>
        <div class="status-card">
            <div class="status-label">Staff On Duty</div>
            <div class="status-value" id="staffOnDuty">5</div>
        </div>
        <div class="status-card">
            <div class="status-label">Active Orders</div>
            <div class="status-value" id="activeOrders">0</div>
        </div>
        <div class="status-card">
            <div class="status-label">Available Staff</div>
            <div class="status-value" id="availableStaff">5</div>
        </div>
    </div>
    ...
    <div style="margin-top: 15px;">
        <div class="meter-labels">
            ...
            <span>100% (All Busy)</span>
        </div>
        <div class="utilization-meter">
            <div class="meter-fill" id="utilizationMeter" style="width: 0%; background: #28a745;"></div>
        </div>
    </div>
    
    <!-- Capacity Alert -->
    <div id="capacityAlert" class="capacity-alert success">
        <i class="fas fa-check-circle"></i>
        <span>All staff available. New orders can be accepted.</span>
    </div>
    
    <!-- Staff Visualization -->
    <h4 style="margin-top: 20px;">Staff Status</h4>
    <div class="staff-grid" id="staffGrid">
        <!-- Staff slots will be dynamically generated -->
    </div>
    
    <!-- Simulation Controls -->
    <div class="current-orders">
        <h4>Order Simulation</h4>
        <p>Simulate new orders to test capacity:</p>
        <div class="order-simulation">
            <button class="order-btn accept" onclick="addOrder()">
                <i class="fas fa-plus"></i> Add New Order
            </button>
            <button class="order-btn reject" onclick="completeOrder()">
                <i class="fas fa-check"></i> Complete Order
            </button>
            <button class="order-btn" onclick="resetOrders()" style="background: #6c757d; color: white;">
                <i class="fas fa-redo"></i> Reset
            </button>
        </div>
        <p id="orderStatusMessage" style="font-size: 14px; margin-top: 10px;">
            Click "Add New Order" to simulate incoming orders
        </p>
    </div>
</div>
